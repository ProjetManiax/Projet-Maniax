...
class modelDemandes extends CI_model{
    ...
    public function getInfosDemande($idDemande){
        $sql = $this->db->query("select service.photoService, idDemande, descriptionDemande, dateDemande, nomService from demande inner join service on demande.idService=service.idService where idDemande =".$idDemande);
        return $sql->result();
    }
}
