...
// fonctions propres aux deals
 ...
 function allDemandesByIdUser(){
  ...
  function getIdOffresDemandesClicked(){
    ...
    $this->load->model("modelDeals");
    $_SESSION["verificationFinale"] = $this->modelDeals->verifMonOffreSaDemande($monOffreCliquee, $saDemandeCliquee, $sonOffreCliquee, $maDemandeCliquee);
  }

  function test_view(){
  $this->load->view('test.php',$_SESSION["verificationFinale"]);
  }
}
