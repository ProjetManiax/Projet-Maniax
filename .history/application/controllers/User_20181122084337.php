...
// fonctions propres aux deals
 ...
 function allDemandesByIdUser(){
  ...
  function getIdOffresDemandesClicked(){
    ...
    $_SESSION["sonOffreEgalMaDemande"] = $this->modelDeals->verifSonOffreMaDemande($sonOffreCliquee, $maDemandeCliquee);

  }

  function test_view(){
    $this->load->view('test.php',$_SESSION["monOffreEgalSaDemande"], $_SESSION["sonOffreEgalMaDemande"]);
  }
}
