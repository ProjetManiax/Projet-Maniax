...
// fonctions propres aux deals
 ...
 function allDemandesByIdUser(){
  ...
  function getIdOffresDemandesClicked(){
    ...
    $this->load->model("modelDeals");
    $_SESSION["verificationFinale"] = $this->modelDeals->verificationFinale($_POST['monOffreCliquee'], $_POST['saDemandeCliquee'], $_POST['sonOffreCliquee'],  $_POST['saDemandeCliquee']);
