            ...
            <div>
                ...
                ?><br>
                    <div class='col-md-12 bg-light'>
                        <img class="imgResize" src="<?php echo $uneDemande->photoService ?>" alt="" ><?php echo $uneDemande->nomService ?><br><?php echo $uneDemande->descriptionDemande ?><?php echo $uneDemande->nomService ?>
