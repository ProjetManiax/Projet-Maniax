            ...
            <form role="form" method="post" action="<?php echo base_url('user/set_offre'); ?>">
                    <fieldset>
                        ...
                        <label>NUMERO DE L'OFFRE</label>
                            <input class="form-control" name="idOffre" type="text" value='<?php echo var_dump($_SESSION['offre']) ;?>' readonly="readonly">
                        </div>

                        <div class="form-group">
                        <label>DESCRIPTION DE L'OFFRE</label>
                            <input class="form-control"  name="descriptionOffre" type="text" value="<?php echo $_SESSION['offre']->offre->idOffre ;?>" required minlength="10" autofocus>
                        </div>
