            ...
            <div class='col-sm-6'>
                <form role="form" method="post" action="<?php echo base_url('user/set_deal'); ?>">
                    <fieldset>
                        ...
                        <input class="form-control" name="saNote" type="number" min="1" max="10" value="<?php /* echo $_SESSION['deal'][0]->noteUser2*/ ?>" autofocus> 
                        </div>
                        
                        <div class="form-group">
                        <label>LA NOTE DE : <font style="text-transform: uppercase;"><?php echo $_SESSION['deal'][0]->nomUser ?></font></label><br>
                        <input class="form-control" name="maNote" type="number" value="<?php /*echo $_SESSION['deal'][0]->noteUser1*/ ?>" readonly="readonly"> 
                        </div><br>
