...
<head>
    ...
    $(document).ready(function() 
            {   
                var cheminImage = $('img').attr('title');
                $("#offre").click(creerConference($cheminImage));               
            }
        );
    </script>
</head>
        ...
        <?php foreach($lesOffres as $uneOffre){ ?> <br>
            ...
            <div class="card" style="width: 18rem; height: 10rem; ">
                <div class="card-header">
                    <h5><?php echo $uneOffre->nomService?><a id='offre' '>
                    <img id='offre' title='<?php echo $uneOffre->idOffre ?>' align=right class="imgResize" src="../images/Edit.ico"></h5>
                </div>
                <div class="card-body">
