    ...
    <section class="container-fluid about">
        ...
        <?php foreach($lesOffres as $uneOffre){
            ...
            <form role="form" id="formOffre" method="post" action="<?php echo base_url('user/setOffre_view'); ?>">
                ...
                <input type="text" value="<?php echo $uneOffre->idOffre ?>">
                <input type="text" value="<?php echo $uneOffre->descriptionOffre ?>">
                <input type="text" value="<?php echo $uneOffre->dateOffre ?>">
                <input type="text" value="<?php echo $uneOffre->nomService ?>">
