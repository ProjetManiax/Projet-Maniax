...
<meta charset="utf-8" />
    ...
    $(document).ready(function() 
            {   
                function recupValeur($(this).attr('value')) {
                     alert(valeurChamp);
                }
            }
        );
...
<body>
    <div>
        <input type="text" onkeyup="recupValeur" class="col-md-12 bg-light" value="" placeholder="Saisie le texte recherché dans une offre"><br>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div>
