...
<body>
    ...
    <section class="container-fluid about">
        ...
        <?php foreach($lesOffres as $uneOffre){ ?> <br>
            <form class='col-md-3' role="form" id="formOffre" method="post" action="<?php echo base_url('user/setOffre_view'); ?>">
    ...
    <article>
        ...
        <div id="divDemandes" class="row align-items-center">    
            <?php foreach($lesDemandes as $uneDemande){
                ?><br>
            <form class='col-md-3' role="form" id="formDemande" method="post" action="<?php echo base_url('user/setDemande_view'); ?>">
                <div class="card" style="width: 18rem;">
