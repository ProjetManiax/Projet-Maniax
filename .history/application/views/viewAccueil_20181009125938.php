...
<body>
    <header class="container-fluid header">
		<div class="container">
		    <p class="logo"><img class="imgUser" src="<?php echo $photoUser ?>" alt="" >  <?php echo $nomUser ?></p>
		    <nav class="menu">
			<a href="#"> Accueil </a>
    ...
    <section class="container-fluid about">
        ...
        <article class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
            ...
            <?php foreach($lesOffres as $uneOffre){
                ...
                <div class="card-body">
                <div class='row'><h5 class="card-title"><?php echo $uneOffre->nomService?></h5><a href="setOffre_view" ><img class="imgUser" src="../images/Edit.ico"></a></div>
