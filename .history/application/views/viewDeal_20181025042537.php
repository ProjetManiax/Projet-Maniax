...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-6 bg-secondary">
            ...
            <div class="col-md-6"><a href="home"><button class="btn btn-lg btn-primary btn-block">VALIDER</button></a></div>&nbsp;&nbsp;&nbsp;&nbsp;
            <div class="col-md-6"><a href="valider"><button class="btn btn-lg btn-primary btn-block" href="home" value="Home" name="home" >Home</button></a></div>
</body>
</html>