    ...
    <section class="container-fluid about">
        ...
        <article class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
            ...
            <?php foreach($lesOffres as $uneOffre){
                ...
                <div class="card-body">
                <div class='row'><div class='align-bottom'><h5 class="card-title"><?php echo $uneOffre->nomService?></h5><a href="setOffre_view" ><img class="imgResize" src="../images/Edit.ico"></a></div></div>
