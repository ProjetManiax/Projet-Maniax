        ...
        <?php foreach($lesOffres as $uneOffre){ ?> <br>
            ...
            <div class="card" style="width: 18rem; height: 10rem; ">
                <div class="card-header">
                    ...
                    <img align=right title='<?php echo $uneOffre->idOffre ?>' class="imgResize" src="../images/Edit.ico" onclick="document.getElementById('formOffre').submit(); return false;"></a></h5>
                </div>
                <div class="card-body">
