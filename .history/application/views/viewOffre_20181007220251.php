...
<form class='col-md-6'role="form" method="post" action="<?php echo base_url('user/register_user'); ?>">
    <fieldset>
        ...
        <label>DESCRIPTION DE L'OFFRE</label>
            <input class="form-control"  name="descriptionOffre" type="text" required minlength="10" autofocus>
        </div>

        <div class="form-group">
        <label>DATE DE L'OFFRE</label>
            <input class="form-control" placeholder="Mot de passe" name="mdp" type="texte" value="" required minlength="4">
        </div><br><br>
