...
<body>
    ...
    <div class="row">
        ...
        <div class="row col-md-12 bg-light">
            <div class="col-md-3"><a href="home"><button class="btn btn-lg btn-primary btn-block">VALIDER</button></a></div>&nbsp;&nbsp;&nbsp;&nbsp;
            <div class="col-md-3"><a href="valider"><button class="btn btn-lg btn-primary btn-block" href="home" value="Home" name="home" >Home</button></a></div>
        </div>  
</body>
</html>