...
<div class='container'>
    ...
    <div class='row'>
                ...
                <form role="form" method="post" action="<?php echo base_url('user/register_demande'); ?>">
                    <fieldset>
                        ...
                        <label>NUMERO DE LA DEMANDE</label>
                            <input class="form-control" name="idDemande" type="text" value='<?php echo $idDemande ;?>' readonly="readonly">
                        </div>

                        <div class="form-group">
                        <label>DESCRIPTION DE LA DEMANDE</label>
                            <input class="form-control"  name="descriptionDemande" type="text" value="<?php echo $descriptionDemande ;?>" required minlength="10" autofocus>
                        </div>

                        <div class="form-group">
                        <label>DATE DE LA DEMANDE</label>
                            <input class="form-control" name="dateDemande" type="date" value="<?php echo $dateDemande ;?>" required>
                        </div>
            ...
            <div class='col-sm-6' style="background-image:url('<?php echo $photoService ;?>');background-repeat: no-repeat;" ><br>
            </div>
    </div>
</div>
</body>
