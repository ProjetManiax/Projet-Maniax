...
<div class='container'>
    ...
    <div class=col-sm><h1 align=right>Création d'une nouvelle demande</h1></div>
        <div class=col-sm>
            <div class='col-md-6'>
                <form role="form" method="post" action="<?php echo base_url('user/register_user'); ?>">
                    <fieldset>
                        ...
                        <label>NUMERO DE LA DEMANDE</label>
                            <input class="form-control-lg" name="idDemande" type="text" disabled>
                        </div>

                        <div class="form-group">
                        <label>DESCRIPTION DE LA DEMANDE</label>
                            <input class="form-control-lg"  name="descriptionDemande" type="text" value="" required minlength="10" autofocus>
                        </div>

                        <div class="form-group">
                        <label>DATE DE LA DEMANDE</label>
                            <input class="form-control-lg" name="date" type="date" value="" required>
                        </div><br><br>
