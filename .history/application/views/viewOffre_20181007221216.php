...
<form class='col-md-6' role="form" method="post" action="<?php echo base_url('user/register_user'); ?>">
    <fieldset>
        ...
        <button class="btn btn-lg btn-primary btn-block" href="home" value="Home" name="home" ></button

    </fieldset>
</form>
</div>
<div class=col-sm><h1 class='col-md-6'>Création d'une nouvelle offre</h1></div>    
</body>
</html>