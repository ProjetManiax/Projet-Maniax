...
<div class='container'>
    ...
    <div class='row'>
                ...
                <form role="form" method="post" action="<?php echo base_url('user/set_deal'); ?>">
                    <fieldset>
                        ...
                        <label>VOTRE SERVICE</label>
                            <input class="form-control"  name="descriptionDeal" type="text" value="" readonly="readonly">
                        </div>

                        <div class="form-group">
                        <label>SERVICE DE : </label>
                            <input class="form-control" name="dateDeal" type="text" value="" readonly="readonly">
                        </div>
            ...
            <div class='col-sm-6'><br>
                <img src="<?php echo $_SESSION['Deal'][0]->photoService ;?>" alt="">
            </div>
    </div>
</div>
</body>
