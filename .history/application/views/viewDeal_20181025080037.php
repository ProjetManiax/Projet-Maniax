...
<body>
    ...
    <div class="row">
        ...
        <div class="row col-md-5 bg-secondary">
            <div><a href="home"><button  align="center" class="btn btn-lg btn-primary btn-block">VALIDER</button></a></div>&nbsp;&nbsp;&nbsp;&nbsp;
            <div><a href="home"><button  align="center" class="btn btn-lg btn-primary btn-block" href="home" value="Home" name="home" >Home</button></a></div>
        </div>
</body>
</html>