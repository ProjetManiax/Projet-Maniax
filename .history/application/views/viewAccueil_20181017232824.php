        ...
        <?php foreach($lesDeals as $unDeal){
            ...
            <div class="card text-white bg-danger mb-3" style="width: auto; ">
                <img class="card-img-top" src="<?php echo $unDeal->photoUser ?>" alt="Card image cap">
                    <div class="card-body" bac='red' align='center'>
                        <h5 class="card-title"><?php echo $unDeal->nomUser ?></h5>
                    </div>
                <p> class="list-group-item" ><?php echo $nomService[0]->nomService2 ?></p>
                <p> class="list-group-item" >vs<p>
                <p> class="list-group-item" ><?php echo $unDeal->nomService ?></p>
                <p> class="list-group-item" ><?php echo $unDeal->dateDeal ?></p>
                <p> class="list-group-item" ><?php echo $unDeal->noteUser1 ?> - <?php echo $unDeal->noteUser2 ?></p>
