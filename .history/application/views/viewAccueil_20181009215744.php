    ...
    <section class="container-fluid about">
        ...
        <article class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
            ...
            <?php foreach($lesOffres as $uneOffre){
                ...
                <div class="card-header"><h5 class="card-title"><?php echo $uneOffre->nomService?><a href="setDemande_view" ><img align=right class="imgResize" src="../images/Edit.ico"></a></h5></div>
                <div class="card-body">
    ...
    <article class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
        ...
        <div id="divDemandes">    
            <?php foreach($lesDemandes as $uneDemande){
                ?><br>
                <div class="card" style="width: 18rem;">
                <div class="card-header"><a href="setDemande_view" ><img class="imgResize" src="../images/Edit.ico"></a></div>
                <div class="card-body">
